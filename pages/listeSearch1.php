...
$req="select t.link,t.dates,l1.nom_langage,l2.nom_langage,t.id_translation from translation t, langage l1,langage l2 where t.id_langage_source=l1.id_langage and t.id_langage_destination=l2.id_langage and t.dates between '".$date_d."' and '".$date_f."'";
}
...
$date_s=$date_spec[2]."-".$date_spec[1]."-".$date_spec[0];	
	...
	$req="select t.link,t.dates,l1.nom_langage,l2.nom_langage,t.id_translation from translation t,edition e, langage l1,langage l2 where  t.id_langage_source=l1.id_langage and t.id_langage_destination=l2.id_langage and t.link='".$_POST['wl']."'";		  
